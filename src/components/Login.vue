<template>
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
        ...
        <form class="space-y-4">
            ...
            <button type="submit" class="w-full bg-slate-600 text-white py-2 px-4 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2">
                Sign In
            </button>
        </form>
    </div>
